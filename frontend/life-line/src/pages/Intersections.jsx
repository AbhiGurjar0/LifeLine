...
export default function TrafficSignalUI() {
    ...
    setSignals((prev) => {
      ...
      contextValue.forEach((signal, i) => {
        ...
        updated[i] = {
          ...
          id: signal?.id ?? updated[i]?.id,
          signal_For: signal?.signal_For ?? updated[i]?.signal_For,
        };
      });
  ...
  const isEditPage = useMatch("/Intersections/edit/:id");
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="space-y-3 text-sm">
                        ...
                        <div className="flex justify-between">
                          <span className="text-slate-600">Signal For</span>
                          <span className="font-semibold">
                            {signal.signal_For}
                          </span>
                        </div>
                    ...
                    <div className="px-6 py-4 bg-slate-50 flex justify-end gap-2">
                      ...
                      <Link to={`/Intersections/edit/${signal.id}`}>
                        {" "}
                ...
                <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        name="signal_For"
                        placeholder="Ex. NS , EW"
                        className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        onChange={handleChange}
                        value={form.signal_For}
                      />
                    </div>
                  </div>
                </div>
